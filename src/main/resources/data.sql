...
VALUES (1, 'Adam', 'Nowak', '1986-12-05'),
       (2, 'Marzena', 'Bis', '2000-05-29'),
       (3, 'Judyta', 'Tasior', '1957-04-11'),
       (4, 'Radek', 'Sienkiewicz', '1987-07-09'),
       (5, 'Marta', 'Nowakowicz', '1999-08-16'),
       (6, 'Grzegorz', 'Dec', '1977-02-17'),
       (7, 'Mariusz', 'Szmagara', '1986-03-04'),
       (8, 'Mateusz', 'Kozak', '1995-05-12'),
       (9, 'Ola', 'Zenek', '1988-10-08'),
       (10, 'Adam', 'Witko', '1997-05-11');
